...
from openvair.modules.scheduler.service_layer.services import SchedulerServiceLayerManager

def test_create_job_service_logic(mock_uow):
...
def test_delete_job_service_logic(mock_uow):
